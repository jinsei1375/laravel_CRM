...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">購入詳細画面</h2>
        </template>
                          ...
                          <div class="flex flex-wrap -m-2">
                            ...
                            <div class="p-2 w-full">
                              <div class="">
                                ...
                                <div v-if="props.order[0].status == true" type="date" id="" name="date" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                  キャンセル
                                </div>
