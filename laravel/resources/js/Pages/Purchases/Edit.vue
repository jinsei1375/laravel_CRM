...
<template>
    <Head title="購props.order[0].customer_id" />

    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">入履歴　編集画面</h2>
        </template>
                          ...
                          <div class="flex flex-wrap -m-2">
                            ...
                            <div class="p-2 w-full">
                              <div class="">
                                ...
                                <div type="text" id="" name="total" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                  {{ totalPrice }}円
                                </div>
                              </div>
                            </div>
