...
<template>
    ...
    <div v-if="data.type === 'decil'" class="lg:w-2/3 w-full mx-auto overflow-auto">
        <table class="table-auto w-full text-left whitespace-no-wrap">
            <thead>
            <tr>
                ...
                <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">合計額</th>
                <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">構成比</th>
            </tr>
            </thead>
            <tbody>
            <tr v-for="item in data.data" :key="item.date">
                <td class="border-b-2 border-gray-200 px-4 py-3">{{ item.decil }}</td>
    ...
    <div v-if="data.type === 'rfm'" class="lg:w-2/3 w-full mx-auto overflow-auto">
        ...
        <h2 class="text-center text-2xl my-4">RFMランクごとの人数</h2>
        <table class="table-auto w-full text-left whitespace-no-wrap">
            <thead>
                <tr>
